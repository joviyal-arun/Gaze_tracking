...
from .defaults_face import mode_Face
...
class FaceModel:
    ...
    medipipe --> 468 facial landmark
    openvino --> converting 468 to 68
    dlib     --> 68 facial landmark
    
    """
    print("-------------------------------",mode_Face.change_coordinate_system())
    if mode_Face.change_coordinate_system() == 'medipipe':
        ...
        CHIN_INDEX: int = 199
        NOSE_INDEX: np.ndarray =  np.array([1])
        
    elif mode_Face.change_coordinate_system() == 'dlib' or mode_Face.change_coordinate_system() == 'openvino':
        print('your landmark name:-',mode_Face.change_coordinate_system())
        LANDMARKS: np.ndarray = np.array([
        ...
        CHIN_INDEX: int = 8
        #NOSE_INDEX: int = 30
        NOSE_INDEX: np.ndarray =  np.array([30])
...
# -----NAVEEN----------
    ...
    def compute_face_eye_centers(self, face: Face,mode) -> None:
        """Compute the centers of the face and eyes.
