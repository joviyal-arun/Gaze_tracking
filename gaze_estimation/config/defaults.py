...
#  Face Detection Process using openvino

config.face_detector = ConfigNode()
config.face_detector.mode = 'openvino'
config.face_detector.openvino = ConfigNode()
config.face_detector.openvino.model = 'data/openvino/face-detection-adas-0001'


# config.face_detector = ConfigNode()
# config.face_detector.mode = 'medipipe'
# config.face_detector.medipipe = ConfigNode()
...
config.demo.video_path = 'video_input/head_straight_eye_straight.avi'
config.demo.output_dir = ''
config.demo.output_file_extension = ''
