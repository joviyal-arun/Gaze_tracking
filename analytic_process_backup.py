        ...
        while True:
            ...
            for face in faces:
                try:
                    ...
                    testing=str(Emotional_estimation)+'_'+str(probaibility_score)+'_'+str(self.pitch)+'_'+str(self.roll)+'_'+str(self.yaw)+'_'+str(self.pitch_eg)+'_'+str(self.yaw_eg)+'_'+str(y_pred)
            ...
            if cv2.waitKey(1) & 0xFF == ord('s'):
                ...
                ret, buffer = cv2.imencode('.jpg',self.visualizer.image)
